...
-- Created on Mon Apr 20 17:08:37 2015
-- 
;
...
CREATE TABLE `payment_orders` (
  ...
  CONSTRAINT `payment_orders_fk_sessions_id` FOREIGN KEY (`sessions_id`) REFERENCES `sessions` (`sessions_id`) ON DELETE CASCADE ON UPDATE CASCADE,
